...
def split_audio(audio, sr=22050, clip_length=8, share_mem=False):
    """
    Split it into 8-second clips, and return a single tensor of all clips.

    Parameters:
    - audio: ndarray loaded by librosa.
    - sr: Sampling rate to use for loading the audio.
    - clip_length: Length of each clip in seconds.
